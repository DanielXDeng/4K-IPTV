...
#下载自启动脚本
echo 正在下载新文件
wget -q --no-check-certificate https://raw.githubusercontent.com/danbuding/4K-IPTV/master/nat-start
#设置权限
...
#下载开机运行脚本
echo 正在下载新文件
wget -q --no-check-certificate https://raw.githubusercontent.com/danbuding/4K-IPTV/master/iptv.conf
#设置权限
